...
Arguments parse_arguments(int argc, char** argv) {
	...
	supported_options.add_options()(
		"help,h", po::bool_switch()->notifier([&args](bool value) { args.show_help = value; }),
		"Show this help message.")("day,d", po::value<int>()->value_name("NUM")->notifier([&args](int day) {
...
void run_task_solutions(advent::Solutions& solutions, advent::TaskID task_id) {
	...
	day->set_up();
	advent::measure_execution_time(day->part_one(), [&] { day->solve_part_one(); });
	advent::measure_execution_time(day->part_two(), [&] { day->solve_part_two(); });
}
